  ...
  const allCategories = [
    ...
    },
    {
      ...
      policies: [
        ...
        { title: "Artificial Intelligence Research Funding", description: "Increase federal funding for AI research and development programs.", impactLevel: "High - $15B AI investment" },
        { title: "Cybersecurity Workforce Development", description: "Fund training programs for cybersecurity professionals to address skills shortage.", impactLevel: "Medium - National security workforce" },
        { title: "Technology Export Controls", description: "Strengthen controls on technology exports to protect national security interests.", impactLevel: "Medium - Export restrictions" },
        { title: "Digital Infrastructure Protection", description: "Enhance protection of critical digital infrastructure from cyber attacks.", impactLevel: "High - Infrastructure security" },
        { title: "Tech Startup Support Program", description: "Provide tax incentives and support for technology startups and small businesses.", impactLevel: "Medium - Innovation ecosystem" },
        { title: "Open Source Software Initiative", description: "Promote development and adoption of open source software in government.", impactLevel: "Low - Software policy" },
        { title: "Cloud Computing Security Standards", description: "Establish federal standards for cloud computing security and data protection.", impactLevel: "Medium - Data security" },
        { title: "Technology Patent Reform", description: "Reform patent system to reduce barriers for technology innovation.", impactLevel: "Medium - Intellectual property" }
      ]
    },
    {
      category: "education",
      ...
      policies: [
        ...
        { title: "Teacher Merit Pay System", description: "Implement performance-based pay systems for teachers based on student outcomes.", impactLevel: "Medium - Teacher compensation" },
        { title: "College Affordability Initiative", description: "Increase Pell Grant funding and expand income-driven repayment options.", impactLevel: "High - College access" },
        { title: "Rural Education Support", description: "Provide additional funding and resources for rural and remote schools.", impactLevel: "Medium - Rural education access" },
        { title: "Bilingual Education Programs", description: "Expand federal support for bilingual and English language learning programs.", impactLevel: "Medium - ESL students" },
        { title: "School Safety Enhancement", description: "Increase funding for school security measures and mental health programs.", impactLevel: "Medium - Student safety" },
        { title: "Arts Education Funding", description: "Restore and expand federal funding for arts and music education programs.", impactLevel: "Low - Creative education" },
        { title: "Community College Support", description: "Increase federal funding for community college programs and workforce training.", impactLevel: "Medium - Community college system" }
      ]
    },
    {
